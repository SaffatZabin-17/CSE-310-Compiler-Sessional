...
public:
    ...
    int getVariableCount(){
        int parentTableVariableCOunt;
        if(parentTable == nullptr){
            parentTableVariableCOunt = 0;
        }
        else{
            parentTableVariableCOunt = parentTable->getVariableCount();
        }
        return variableCount + parentTableVariableCOunt;
    }

    void addToVariableCount(int n){
